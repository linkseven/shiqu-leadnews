...
import com.shiqu.common.constants.WmNewsMessageConstants;
import com.shiqu.common.exception.CustomException;
import com.shiqu.wemedia.mapper.WmMaterialMapper;
...
import com.shiqu.common.constants.WemediaConstants;
import com.shiqu.model.common.dtos.PageResponseResult;
...
import com.shiqu.utils.thread.WmThreadLocalUtil;
import com.shiqu.wemedia.mapper.WmNewsMapper;
import com.shiqu.wemedia.mapper.WmNewsMaterialMapper;
...
public class WmNewsServiceImpl  extends ServiceImpl<WmNewsMapper, WmNews> implements WmNewsService {
    ...
    public ResponseResult delNews(Integer id) {
        ...
        if (flag){
            return ResponseResult.okResult("已删除");
        } else {
            return ResponseResult.errorResult(501, "文章id有误");
        }
    }
}