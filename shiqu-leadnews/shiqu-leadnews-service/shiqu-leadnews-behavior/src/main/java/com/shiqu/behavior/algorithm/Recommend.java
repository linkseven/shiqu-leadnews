package com.shiqu.behavior.algorithm;
...
public class Recommend {
    ...
    public List<UserArticleVo> recommend(Integer userId, List<UserArticleStorageVo> userArticleStorageVos){
        ...
        //List<UserArticleVo> userArticleVoList = getUserArticleVoList(neighborRatings.getUserId());
...
/*        List<UserArticleVo> userArticleVoList1 = getUserArticleVoList(userRatings.getUserId());
        System.out.println("用户感兴趣的文章 -> " + userArticleVoList1);*/
